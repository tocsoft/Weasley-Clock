...
collaWidth = 1.2;
    gearDiamater = 35 + (3 - (gear -1)) * 10;
    collaHeightOffset= (gear -1) * 3.6 + (gear -1) * 3;
    
    bushingDi = 10;
    
    collaDiamater = 8 - ((gear -1) * 2);
    
    collaHeight = 10  + collaHeightOffset;
    bushingHeight = 2;
    ...
    difference() {
        difference() {
            union(){
                ...
                difference(){
                    cylinder(gearHeight -1, bushingDi +2, bushingDi+2, false);
        ...
        translate([gearDiamater *0.43,-2, gearHeight /2]) {
        //    #cube([1,6,tabHeight], false);
        }
        
    
}

shaftedGear(1, 0, 12, 60);
translate([55,55,0]){shaftedGear(2); }
translate([110,-55,0]){shaftedGear(3); }
translate([165,55,00]){shaftedGear(4); }
